    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
                ...
                <a href="{{ route('settings.configurations.index') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                    <i class="fas fa-cogs text-yellow-500 mr-4"></i>
                    <span class="font-medium text-gray-700">System Settings</span>
                </a>
                <a href="{{ route('settings.role-permissions.index') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                    <i class="fas fa-user-shield text-red-500 mr-4"></i>
