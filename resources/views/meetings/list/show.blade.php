...
@section('content')
    <div class="container-fluid px-6 py-4">
        <div class="py-4">
            <a href="{{ session('meeting_list_url', route('meeting.meeting-lists.index')) }}" class="inline-flex items-center text-sm font-semibold text-green-600 hover:text-green-800 mb-4">
                ...
                Back to Meeting List {{ session('meeting_list_url') ? '(Saved Filter)' : '' }}
            </a>
