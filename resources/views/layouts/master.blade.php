...
<head>
    ...
    <link rel="icon"
        href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><path fill='%23089244' d='M416 0H96C60.7 0 32 28.7 32 64V448c0 35.3 28.7 64 64 64H416c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64zM288 288c-17.7 0-32 14.3-32 32s14.3 32 32 32s32-14.3 32-32s-14.3-32-32-32z'/></svg>">
...
<body class="overflow-hidden">
    ...
    <div x-data="{ sidebarOpen: true }" class="flex h-screen bg-gray-100">
        ...
        <div x-show="sidebarOpen" @click="sidebarOpen = false"
            class="fixed inset-0 z-40 bg-black bg-opacity-50 transition-opacity lg:hidden"></div>
        ...
        <div x-show="sidebarOpen" x-cloak
            ...
            <div class="flex items-center justify-center h-20 bg-white border-b border-gray-100 mb-2">
                <a href="{{ route('dashboard') }}"
                    class="flex items-center text-gray-800 text-2xl font-bold tracking-wider uppercase hover:text-green-600 transition-colors">
                    Doors
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto mt-4 px-2 space-y-1">
                ...
                @auth
                    ...
                    <x-sidebar-link :href="route('tablet.room.display', ['room' => 1])"
                        :active="request()->routeIs('tablet.room.display')">
            ...
            <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-primary">
                ...
                <div class="flex items-center">
                    ...
                    @auth
                        ...
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="trigger">
                                ...
                                <button id="nav-profile-dropdown"
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}"
                            class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-green-500">Log
                            in</a>

                        @if (Route::has('register'))

                            <a href="{{ route('register') }}"
                                class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-green-500">Register</a>
